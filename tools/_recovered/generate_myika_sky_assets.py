...
def build_cloud_material():
    ...
    coverage_clamp = create_expression(material, unreal.MaterialExpressionClamp, 1060, 310)
    ...
    set_prop(coverage_clamp, "min_default", 0.0)
    set_prop(coverage_clamp, "max_default", 1.0)
    ...
    unreal.MaterialEditingLibrary.connect_material_expressions(coverage_bias, "", coverage_clamp, "Input")
